...
<div className="flex mt-10 justify-between gap-5">
    ...
    <h2 className="text-2xl font-semibold"></h2> 
        <h3 className="text-xl font-medium">Add DogsForSale</h3>

        <button    onClick={() => setShowModel(true)} className="mt-4 px-4 py-2 rounded-lg bg-white text-black-500 font-semibold hover:bg-gray-200" >
     Add
        </button>
      </div>
    </div> 
